...
import { ensureDeveloperExistsMiddleware, ensureEmailIsNew } from "./middlewares/developers.middlewares";
import { createProject, creteTechToProject, deleteProject, getAllProjects, getProjectById, updateProjectInfo } from "./logics/projects.logic";
import { ensureProjectExistsMiddleware, ensureTecExistsMiddleware } from "./middlewares/projects.middlewares";
...
app.post("/developers/:id/infos", ensureDeveloperExistsMiddleware, createDeveloperInfos);
...
app.patch("/projects/:id", ensureProjectExistsMiddleware, updateProjectInfo);
app.delete("/projects/:id", ensureProjectExistsMiddleware, deleteProject);
app.post("/projects/:id/technologies", ensureProjectExistsMiddleware, ensureTecExistsMiddleware, creteTechToProject);
